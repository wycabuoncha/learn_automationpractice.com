...
public class SignuppageTest extends BaseTest {
	...
	public void signupForm()  throws InterruptedException {
		...
		signupPage.getCity().sendKeys("Nairobi");
		signupPage.selectState("8");
		signupPage.getPostCode().sendKeys("45657678");
		signupPage.setCountry();
		signupPage.getOther().sendKeys("Please deliver the items to my second address if you get my phone number is switched off");
